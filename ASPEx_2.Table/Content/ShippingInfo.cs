...
namespace ASPEx_table
{
	...
	public class ShippingInfo : Object, IComparable
	{
		...
		{
			// V2Generator: Body Start
			ASPEx_sql.ShippingInfo.ShippingInfoDelete (this.m_ID);
			// V2Generator: Body End
		}
		...
		{
			// V2Generator: Body Start
			ASPEx_sql.ShippingInfo.ShippingInfoUpdate (ID, OrderID, Type, Cost, Address);
		...
		{
			// V2Generator: Body Start
			this.m_ID			= ASPEx_sql.ShippingInfo.ShippingInfoInsert (this.m_OrderID, this.m_Type, this.m_Cost, this.m_Address);
			// V2Generator: Body End
		}
