 ...
 *
 * DATE						 WHO                ACTION
 * 8/23/2017  Volume RADA Generator (Version 6.1)	Created
 *
 *-------------------------------End Version Control-------------------------------------*/
...
namespace ASPEx_table
{
	...
	public class Account : GenericPrincipal, IComparable
	{
		...
		public static Account ExecuteCreate (int ID)
		{
			...
			DataTable   				  dt  		  = ASPEx_sql.Account.AccountGetByID(ID);
		...
		public static List<Account> List ()
		{
			...
			DataTable			dt					= ASPEx_sql.Account.AccountList();
		...
		{
			// V2Generator: Body Start
			ASPEx_sql.Account.AccountDelete (this.m_ID);
			// V2Generator: Body End
		}
		...
		{
			// V2Generator: Body Start
			ASPEx_sql.Account.AccountUpdate (ID, FirstName, LastName, Email, Password, Salt, ContactNo, ShippingAddress, Country, Status, Role, DateCreated, DateModified, CreatedAccountID, ModifiedAccountID);
		...
		{
			// V2Generator: Body Start
			this.m_ID			= ASPEx_sql.Account.AccountInsert (this.m_FirstName, this.m_LastName, this.m_Email, this.m_Password, this.m_Salt, this.m_ContactNo, this.m_ShippingAddress, this.m_Country, this.m_Status, this.m_Role, this.m_DateCreated, this.m_DateModified, this.m_CreatedAccountID, this.m_ModifiedAccountID);
			// V2Generator: Body End
		}
